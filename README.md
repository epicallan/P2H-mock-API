...
## Example
Let’s say you need an endpoint like <http://localhost:3001/api/example> which should return:
...
## Default Address
The server runs at <http://localhost:3001/> providing a page with links to all existing API endpoints.
...
# eg. http://localhost:3001/api/foo
API_PREFIX=/api
